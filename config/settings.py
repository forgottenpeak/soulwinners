...
BUY_ALERT_KEYS = [
    "59648c8b-a691-451b-b1ee-3542ad7afd36",
    "2c353fb3-653a-47d2-8247-2286ac7098a8",
    "ee2a7d3e-2935-4736-8c3f-113c268f5510",
    "b371c9f4-2ff4-4426-8949-7125b814a421",
]
HELIUS_FREE_KEYS = BUY_ALERT_KEYS  # Alias
CLUSTER_KEYS = BUY_ALERT_KEYS  # Alias for cluster analysis
INSIDER_DETECTION_KEYS = BUY_ALERT_KEYS  # Alias for insider detection
HELIUS_MONITORING_KEYS = BUY_ALERT_KEYS  # Alias for monitoring
HELIUS_PREMIUM_KEY = HELIUS_API_KEYS[0]  # Premium key for priority requests
